...
// 官方教程(https://tour.golang.org/methods/24)
...
// - - -
//
// Note: the `Rectangle` return value of the `Bounds` method
// is actually an `image.Rectangle`, as the declaration is inside package `image`.
//
